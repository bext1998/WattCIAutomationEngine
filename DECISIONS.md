...
| 摘要 | 狀態 | 唯一權威來源 |
|---|---|---|
| spec.md v1.3 經 Maze 正式審查確認，狀態由 Draft 轉為 Review；§7 `[FROZEN]` 契約自此定案，修改需走 spec revision。v1.4（2026-08-17）依 Issue #41 規格審查修訂 §13 AC-1／§4.1／§10.1 措辭，經使用者確認；§7 FROZEN 範圍未變動 | 有效 | docs\spec.md 標頭、§7、§15 |
